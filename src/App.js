        ...
        <tbody>
          ...
          {table.rows[0].children.map((ele, i) => {
            const IsChildBtn = () => {
              ...
              let ParentPer = parent * Number(inputValues[i]) / 100
              console.log('====================================');
              console.log("LLLL", parent, "inputValues", inputValues[i]);
              console.log('====================================');
            ...
            const IsChildBtn2 = (i) => {
              ...
              console.log('====================================');
              console.log("LLLL", ParentPer, "inputValues", Number(inputValues.reduce((a, b) => Number(a) + Number(b))));
              console.log('====================================');
              setIsChildren(`${ParentPer}`)
            }
            return (
